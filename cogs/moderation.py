...
class Moderation(commands.Cog, description="Hi"):
    ...
    @commands.command(brief="Ban a member.",help="Ban a member!",aliases=['b'])
    ...
    @commands.command(brief="Unban a member!",help="Unban a member with their ID.",aliases=['ub'])
    @commands.has_permissions(ban_members=True)
    ...
    @commands.command(brief="Kick a member!",help="Kick a member.",aliases=['k'])
    ...
    @commands.command(brief="Clear some messages",help="Clear messages.",aliases=['cle'])
    ...
    @commands.command(brief="Mute a member.",help="Mute a member.",aliases=['m'])
    @commands.has_permissions(kick_members=True)
    async def mute(self,
                   ctx,
                   member: discord.Member, *,
    ...
    @commands.command(brief="Unmute a member!",help="Unmute a member.",aliases=['demute', 'um'])
    @commands.has_permissions(kick_members=True)
    ...
    @commands.command(brief="Warn some fricking member, idk.",help="Warn a member",aliases=['w'])
    @commands.has_permissions(kick_members=True)
    async def warn(self,
                   ctx,
                   member: discord.Member, *,
        ...
        embed = discord.Embed(colour=self.bot.grey)
    ...
    @commands.command(brief="Srart a giveaway.",help="Start a giveaway.",aliases=['g'])
